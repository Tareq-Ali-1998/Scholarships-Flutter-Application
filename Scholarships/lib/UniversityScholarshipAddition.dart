...
class UniversityScholarshipAddition extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return UniversityScholarshipAdditionState();
  }
}

class UniversityScholarshipAdditionState
    extends State<UniversityScholarshipAddition> {
  String studyLevel = "Bachelor";
  TextEditingController specificationController =
      new TextEditingController(text: "");
  TextEditingController startAgeController =
      new TextEditingController(text: "");
  TextEditingController endAgeController = new TextEditingController(text: "");
  TextEditingController perfectAgeController =
      new TextEditingController(text: "");
  String englishLevel = "B3";
  String startAverage = "70";
  String academicLanguage = "English";
  ...
  TextEditingController englishLevelPercentageController =
      new TextEditingController(text: "");
  String fundation = "Not funded";
  TextEditingController linkController = new TextEditingController(text: "");
  ...
  AlertDialog areYouSure() {
    final AlertDialog alert = AlertDialog(
      title: Text("Are you sure you want add this scholarship?"),
      content: Container(
        height: 70,
        child: Column(
          children: [
  ...
  void add() {
    setState(() {
      ...
      universityScholarships.add(newScholarship);
