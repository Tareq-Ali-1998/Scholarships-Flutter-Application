...
class UniversityModificationPowers extends StatefulWidget {
  const UniversityModificationPowers({Key key}) : super(key: key);

  @override
  UniversityModificationPowersState createState() => UniversityModificationPowersState();
}

class UniversityModificationPowersState extends State<UniversityModificationPowers> {
  String s =
