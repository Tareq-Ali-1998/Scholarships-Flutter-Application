...
class SingleScholarshipOverview extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return SingleScholarshipOverviewState();
  }
}

class SingleScholarshipOverviewState extends State<SingleScholarshipOverview> {
  ...
  void handleWeightingError() {
    setState(() {
      ...
      if (!((englishLevelPercentageController.text.length > 0) &&
        ...
        weightingError = "English level percentage should be between 0 and 100";
        return;
      }
  ...
  void save() {
    setState(() {
      ...
      if ((specificationError.length == 0) &&
          ...
          (linkError.length == 0)) {
        //We are re-downloading in anticipation of some other updates.
